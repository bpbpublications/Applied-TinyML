# Local training pipeline for "Ricardo / ATML > 5.2 > People Counter"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-344166 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-344166 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-344166 --data-directory data --out-directory out
    ```
