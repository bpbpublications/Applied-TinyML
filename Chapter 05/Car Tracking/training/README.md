# Local training pipeline for "Ricardo / ATML > 5.3 > Car Counter"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-340135 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-340135 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-340135 --data-directory data --out-directory out
    ```
