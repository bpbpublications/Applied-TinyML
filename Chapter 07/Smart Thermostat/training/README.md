# Local training pipeline for "Ricardo / ATML > 7.2 > Smart Thermostat"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-368150 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-368150 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-368150 --data-directory data --out-directory out
    ```
