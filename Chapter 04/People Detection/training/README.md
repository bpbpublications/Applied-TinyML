# Local training pipeline for "Ricardo / ATML > 4.2 > People Detector"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-323408 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-323408 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-323408 --data-directory data --out-directory out
    ```
