...
# Edge Impulse library for ATML > 2.2 > Noisy People

This is a C++ library that lets you run the impulse for "ATML > 2.2 > Noisy People" (https://studio.edgeimpulse.com/studio/291172) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
