# Local training pipeline for "Ricardo / ATML > 2.2 > Noisy People"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-291172 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-291172 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-291172 --data-directory data --out-directory out
    ```
