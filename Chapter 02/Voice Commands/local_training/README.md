# Local training pipeline for "Ricardo / ATML > 2.3 > Voice Commands"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-277828 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-277828 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-277828 --data-directory data --out-directory out
    ```
