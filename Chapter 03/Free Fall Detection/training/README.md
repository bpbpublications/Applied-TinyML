# Local training pipeline for "Ricardo / ATML > 3.2 > Free Fall Detection"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-300899 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-300899 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-300899 --data-directory data --out-directory out
    ```
