# Local training pipeline for "Ricardo / ATML > 3.3 > Driving Style"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-301063 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-301063 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-301063 --data-directory data --out-directory out
    ```
