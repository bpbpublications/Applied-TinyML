# Local training pipeline for "Ricardo / ATML > 8.1 > Rowing Machine Anomaly"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-378012 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-378012 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-378012 --data-directory data --out-directory out
    ```
