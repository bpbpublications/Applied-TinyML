# Local training pipeline for "Ricardo / ATML > 8.2 > Machine Sound Anomaly"
...
3. Build the container:
    ...
    ```
    $ docker build -t custom-block-378013 .
    ```
...
4. Train your model:
    ...
    **macOS, Linux**
    ...
    ```
    $ docker run --rm -v $PWD:/scripts custom-block-378013 --data-directory data --out-directory out
    ```

    **Windows**

    ```
    $ docker run --rm -v "%cd%":/scripts custom-block-378013 --data-directory data --out-directory out
    ```
